...
public class ColorBlobDetectionView extends SampleCvViewBase implements OnTouchListener {
	...
	private WheelphoneBlobDetection mainView;
	...
	public ColorBlobDetectionView(Context context, AttributeSet attrs, int defStyle)
	{
        super(context, attrs, defStyle);
        setOnTouchListener(this);
	}
	
	public void setMainView(WheelphoneBlobDetection bad) {
		mainView = bad;
	}
	...
	protected Bitmap processFrame(VideoCapture capture) {
        ...
        {            
            ...
            mainView.followBlob(mDetector.getCenter(), mDetector.getRadius(), mRgba.width(), mRgba.height());
        }
