...
public abstract class VideoStream extends MediaStream {
	...
	public void prepare() throws IllegalStateException, IOException {
		...
		if (camera == null) {
			...
			//parameters.setRotation(90);	// not working
			//parameters.setPreviewSize(480, 320);
			//parameters.setPreviewFormat(ImageFormat.NV21);
			//parameters.set("orientation", "landscape");	// not working
			//parameters.set("rotation", 180);	// not working
			camera.setParameters(parameters);
			//camera.setDisplayOrientation(90); //quality.orientation);	// not working
			camera.unlock();
		...
		//super.setOrientationHint(90);	// not working
