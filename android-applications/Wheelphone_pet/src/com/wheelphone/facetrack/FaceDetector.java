...
public class FaceDetector {
	...
	public class Face {
		...
		public void setDistanceToCenter(PointF distanceToCenter){
			mDistanceToCenter = distanceToCenter;
		}

		public void setDesiredEyesDist(float desiredEyesDist){
			mDesiredEyesDist = desiredEyesDist;
		}

		public PointF getDistanceToCenter(){
			if (mDistanceToCenter == null){
				...
				float mFaceDistToCenterX = ((2000*(mMidPointX)/mWidth) - 1000);
				float mFaceDistToCenterY = -(2000*(mMidPointY)/mHeight) + 1000;

				mDistanceToCenter = new PointF(mFaceDistToCenterX, mFaceDistToCenterY);
			}
			return mDistanceToCenter;
		}

		public float getDesiredEyesDist(){
			return mDesiredEyesDist;
		}
		...
		private PointF  mDistanceToCenter;
