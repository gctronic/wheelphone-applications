...
#define  LOG_TAG    "com.wheelphone.facetrack.FaceDetector"
...
#include "jni.h"
#include "com_wheelphone_facetrack_FaceDetector.h"
...
(JNIEnv *_env, jclass _this)
{
    ...
    jclass faceClass = _env->FindClass("com/wheelphone/facetrack/FaceDetector$Face");
...
(JNIEnv *_env, jobject _this, jint w, jint h, jint maxFaces)
{
    ...
    // int filedesc = open("/system/usr/share/bmd/RFFstd_501.bmd", O_RDONLY);
    int filedesc = open("/system/usr/share/bmd/RFFspeed_501.bmd", O_RDONLY);
...
JNIEXPORT jint JNICALL Java_com_wheelphone_facetrack_FaceDetector_fft_1detect
  (JNIEnv *_env, jobject _this, jbyteArray bwbufferObject)
{
    ...
    jbyte* bwbuffer = _env->GetByteArrayElements(bwbufferObject, NULL);
    ...
    _env->ReleaseByteArrayElements(bwbufferObject, bwbuffer, JNI_ABORT);
...
JNIEXPORT void JNICALL Java_com_wheelphone_facetrack_FaceDetector_fft_1get_1face
  (JNIEnv *_env, jobject _this, jobject face, jint index)
{
    btk_HDCR hdcr = (btk_HDCR)(_env->GetIntField(_this, gFaceDetectorOffsets.dcr));
    btk_HFaceFinder hfd =
        (btk_HFaceFinder)(_env->GetIntField(_this, gFaceDetectorOffsets.fd));
