...
public class USBAccessoryManagerAndroidLib extends USBAccessoryManager {
	 ...
	 */
	public USBAccessoryManagerAndroidLib(Handler handler, int what) {
			...
			if( accessory != null) {			
				...
				if(deviceManager.hasPermission(accessory)) {	
					...
					if(parcelFileDescriptor != null) {
						...
						handler.obtainMessage(what, new USBAccessoryManagerMessageAndroidLib(USBAccessoryManagerMessageAndroidLib.MessageType.READY, accessory)).sendToTarget();
	...
	public String getVersion() {
		return  ((UsbManager) mContext.getSystemService(Context.USB_SERVICE)).getAccessoryList()[0].getVersion();
	}
	
	@SuppressLint("NewApi")
	public String getModel() {
		return  ((UsbManager) mContext.getSystemService(Context.USB_SERVICE)).getAccessoryList()[0].getModel();
	}
	
	@SuppressLint("NewApi")
	public String getDescription() {
		return  ((UsbManager) mContext.getSystemService(Context.USB_SERVICE)).getAccessoryList()[0].getDescription();
	}
