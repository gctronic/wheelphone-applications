 ...
 *
 */
public class USBAccessoryManagerMessageAndroidLib extends USBAccessoryManagerMessage {
	 ...
	 */
	public USBAccessoryManagerMessageAndroidLib(MessageType type) {
		this.type = type;
	}
	 ...
	 */
	public USBAccessoryManagerMessageAndroidLib(MessageType type, byte[] data) {
		this.type = type;
		this.data = data;
	}
	 ...
	 */
	public USBAccessoryManagerMessageAndroidLib(MessageType type, byte[] data, UsbAccessory accessory) {
		this.type = type;
		this.data = data;
	 ...
	 * @param accessory The accessory associated with this message
	 */
	public USBAccessoryManagerMessageAndroidLib(MessageType type, UsbAccessory accessory) {
		this.type = type;
		this.accessory = accessory;
	}
