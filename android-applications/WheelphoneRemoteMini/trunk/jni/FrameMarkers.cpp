...
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_initTracker(JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL
    Java_com_wheelphone_remotemini_WheelphoneRemoteMini_deinitTracker(JNIEnv *, jobject)
{
...
Java_com_qualcomm_QCARSamples_FrameMarkers_FrameMarkersRenderer_renderFrame(JNIEnv *env, jobject obj)
{
    ...
    for(int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
    {
		...
		if(marker.getMarkerId() == 1) {
            ...
            jint jx = (int)result.data[0];
            jint jy = (int)result.data[1];
            jclass javaClass = env->GetObjectClass(obj);
           	jmethodID method = env->GetMethodID(javaClass, "displayMessageInt2", "(II)V");
           	env->CallVoidMethod(obj, method, jx, jy);              
            ...
            //jfloat jdist = distance;
            //jclass javaClass = env->GetObjectClass(obj);
           	//jmethodID method = env->GetMethodID(javaClass, "displayMessageFloat", "(F)V");
           	//env->CallVoidMethod(obj, method, jdist);         
...
JNIEXPORT void JNICALL
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_getTrackInfo(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_initApplicationNative(
...
JNIEXPORT void JNICALL
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_deinitApplicationNative(
...
JNIEXPORT void JNICALL
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_startCamera(JNIEnv *,
                                                                         jobject)
{
...
JNIEXPORT void JNICALL
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_stopCamera(JNIEnv *,
                                                                   jobject)
{
...
JNIEXPORT void JNICALL
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_setProjectionMatrix(JNIEnv *, jobject)
{
...
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_autofocus(JNIEnv*, jobject)
{
    return QCAR::CameraDevice::getInstance().setFocusMode(QCAR::CameraDevice::FOCUS_MODE_TRIGGERAUTO) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_setFocusMode(JNIEnv*, jobject, jint mode)
{
    int qcarFocusMode;
...
JNIEXPORT void JNICALL
Java_com_wheelphone_remotemini_WheelphoneRemoteMini_updateRendering(
                        JNIEnv* env, jobject obj, jint width, jint height)
{
